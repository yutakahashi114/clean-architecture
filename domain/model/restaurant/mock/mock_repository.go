...
// Source: domain/model/restaurant/repository.go
...
import (
	...
	restaurant "github.com/yutakahashi114/clean-architecture/domain/model/restaurant"
	reflect "reflect"
)
...
func (m *MockRepository) GetByID(arg0 context.Context, arg1 restaurant.ID) (*restaurant.Restaurant, error) {
	m.ctrl.T.Helper()
